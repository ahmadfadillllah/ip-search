<!--**********************************
        ...
        ***********************************-->
        <div class="footer">
            ...
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://adhyy.my.id/" target="_blank">IT Team</a>
                    2024</p>
            </div>
        </div>
        <!--**********************************
        ...
        <script src="{{ asset('dashboard/xhtml') }}/vendor/datatables/js/jquery.dataTables.min.js"></script>
        <script src="{{ asset('dashboard/xhtml') }}/js/plugins-init/datatables.init.js"></script>
